...
namespace POS.SQLServerDAL
{
    public partial class SalesPromotionManage : ISalesPromotion
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(POS.Model.BaseSalesPromotionTable model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(POS.Model.BaseSalesPromotionTable model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public POS.Model.BaseSalesPromotionTable GetModel(string CODE)
        {
            ...
            POS.Model.BaseSalesPromotionTable model = new POS.Model.BaseSalesPromotionTable();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BASE_SALES_PROMOTION set STATUS_FLAG = " + Constant.DELETE);
            strSql.Append(" where CODE=@CODE ");
            SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,50)};
            parameters[0].Value = CODE;
