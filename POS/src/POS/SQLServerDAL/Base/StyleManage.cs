...
{
    public partial class StyleManage : IStyle
    {
        ...
        public bool Exists(string CODE)
        {
            ...
            strSql.Append("select count(1) from BASE_STYLE");
        ...
        public int Add(BaseStyleTable model)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BASE_STYLE(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BASE_STYLE set ");
        ...
        public bool Delete(string CODE)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BASE_STYLE set STATUS_FLAG = " + Constant.DELETE);
            strSql.Append(" where CODE=@CODE ");
            SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,50)};
            parameters[0].Value = CODE;
        ...
        public BaseStyleTable GetModel(string CODE)
        {
            ...
            strSql.Append("from BASE_STYLE BUN ");
            ...
            BaseStyleTable model = new BaseStyleTable();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT CODE,NAME,STATUS_FLAG,ATTRIBUTE1,ATTRIBUTE2,ATTRIBUTE3,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME");
            strSql.Append(" FROM BASE_STYLE");
            if (strWhere.Trim() != "")
            {
