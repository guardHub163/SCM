...
{
    public partial class ColorManage : IColor
    {
        public ColorManage()
        { }
        #region  Method
        ...
        public bool Exists(string CODE)
        {
            ...
            strSql.Append("select count(1) from BASE_COLOR");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(BaseColorTable model)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BASE_COLOR(");
            strSql.Append("CODE,NAME,STATUS_FLAG,ATTRIBUTE1,ATTRIBUTE2,ATTRIBUTE3,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_TIME,LAST_UPDATE_USER)");
            strSql.Append(" values (");
            strSql.Append("@CODE,@NAME,@STATUS_FLAG,@ATTRIBUTE1,@ATTRIBUTE2,@ATTRIBUTE3,@CREATE_USER,getdate(),getdate(),@LAST_UPDATE_USER)");
            SqlParameter[] parameters = {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(BaseColorTable model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BASE_COLOR set ");
        ...
        public bool Delete(string CODE)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("UPDATE BASE_COLOR SET STATUS_FLAG = " + CConstant.DELETE);
            strSql.Append(" where CODE=@CODE ");
            SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,50)};
            parameters[0].Value = CODE;
        ...
        public BaseColorTable GetModel(string CODE)
        {
            ...
            BaseColorTable model = new BaseColorTable();
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.* from BASE_COLOR T ");
