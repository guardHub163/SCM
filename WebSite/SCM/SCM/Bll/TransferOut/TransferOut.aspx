<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="TransferOut.aspx.cs" Inherits="SCM.Web.TransferOut.TransferOut" %>
        ...
        <ContentTemplate>
            ...
            <table cellpadding="0px;" cellspacing="0px;" class="inputTable">
                <tr>
                    ...
                    <td class="tdText_2">
                        <asp:TextBox ID="txtDeparturlDate" runat="server" Width="120" OnTextChanged="DeparturlDate_Changed"
                ...
                <tr>
                    ...
                    <td class="tdText_2">
                        <asp:TextBox ID="txtArrivalDate" runat="server" Width="120" OnTextChanged="ArrivalDate_Changed"
                            AutoPostBack="true" MaxLength="10"></asp:TextBox>
            ...
            <table class=" searchTable" cellpadding="0px;"
                cellspacing="0px;">
                <tr>
