<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="PurchaseInput.aspx.cs" Inherits="SCM.Web.TransferIn.PurchaseInput" %>
            ...
            <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td class="tdText_2">
                            <select id="selInputType" style="width: 180px;" runat="server">
                                <option value="1" selected="selected">成品</option>
                            </select>
                        </td>
                        <td class="tdTitle_2">
                            入库仓库:
                        ...
                        <td class="tdText_2">
                            <asp:TextBox ID="txtWarehouseCode" runat="server" Width="60" OnTextChanged="Warehouse_Change"
                                CssClass="inputText" AutoPostBack="true"></asp:TextBox>
                            <img title="入库查询" alt="" src="../../Images/search.jpg" class="inputImg" onclick="processMasterClick('WAREHOUSE','<%=this.txtWarehouseCode.ClientID%>','<%=this.lblWarehouseName.ClientID%>');" />
                ...
                <table cellpadding="0px;" cellspacing="0px;" class="inputTable">
                    ...
                    <tr>
                        ...
                        <td class="tdText_2">
                            <asp:TextBox ID="txtLineAttribute1" runat="server" Width="180"></asp:TextBox>
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tdText_2">
                            <asp:TextBox ID="txtPrice" runat="server" Width="180" MaxLength="8"></asp:TextBox>
                        </td>
                        <td class="tdTitle_2">
                            备注2:
                        </td>
                        <td class="tdText_2">
                            <asp:TextBox ID="txtLineAttribute2" runat="server" Width="180"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdTitle_2">
                        ...
                        <td class="tdText_2">
                            <asp:TextBox ID="txtQuantity" runat="server" Width="180" MaxLength="8"></asp:TextBox>
                        </td>
                        <td class="tdTitle_2">
                            备注3:
                        </td>
                        <td class="tdText_2">
                            <asp:TextBox ID="txtLineAttribute3" runat="server" Width="180"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                ...
                <table class="searchTable" cellpadding="0px;" cellspacing="0px;">
                    <tr>
                     <td style="text-align: left; color:Green;">
                            <a href="#" onclick="window.open('../../ExplainHtml/ExcelExplain.html')">导入明细方法</a>
                        </td>
                        <td>
                            <asp:CheckBox ID="chkItem" runat="server" Text="生成原料采购订单" Checked="true" Font-Size="Larger" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
