    ...
    public partial class PurchaseModify : BaseModalDialogPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (slipNumer != null)
                {
                    this.lblTitle.InnerHtml = "采购&nbsp;>>&nbsp;成品采购&nbsp;>>&nbsp;编辑";
                    ...
                    else if (Request.Params["SHOW_FLAG"] != null && Request.Params["SHOW_FLAG"].ToString() == "1")
                    {
                        this.btnSave.Enabled = false;
                        this.btnSave.Visible = false;
                        this.lblTitle.InnerHtml = "采购&nbsp;>>&nbsp;成品采购&nbsp;>>&nbsp;详细";
                    }
                }
                else
                {
                    try
                    {
                        BaseUserTable userTable = (BaseUserTable)ViewState["UserInfo"];
                        this.txtUser.Text = userTable.USER_ID;
                        this.lblUserName.Text = userTable.TRUE_NAME;                        
                    }
                    catch { }
                    dt = InitDataTable();
                    this.lblTitle.InnerHtml = "采购&nbsp;>>&nbsp;成品采购&nbsp;>>&nbsp;新建";
                }
        ...
        private void Save(object sender, EventArgs e)
        {
            ...
            purchaseTable.CHK_ITEM = chkItem.Checked;
