<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="TransferRelationShow.aspx.cs" Inherits="SCM.Web.TransferIn.TransferRelationShow"
    Title="明细" %>
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" CssClass="ScrollPanel"
                ...
                <asp:GridView ID="gridView" runat="server" CellPadding="0" CellSpacing="0" DataKeyNames="LINE_NUMBER"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-Width="100px" DataField="COLOR" ReadOnly="True" />
