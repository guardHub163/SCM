...
{
    public partial class TransferRelationShow : BaseModalDialogPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (slipNumer != null)
                {
                    ds = bll.GetTransferRelationDetail(slipNumer.ToString().Trim());
                    dt = ds.Tables[0];
                    ...
                    this.txtDeparturlDate.Text = Convert.ToString(dt.Rows[0]["CREATE_DATE_TIME"]);
        ...
        private void Save(object sender, EventArgs e)
        {
            ...
            shipmentTable.ARRIVAL_DATE = DateTime.Parse(txtDeparturlDate.Text);
