<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="ReceiptInput.aspx.cs" Inherits="SCM.Web.TransferIn.ReceiptInput" %>
            ...
            <ContentTemplate>
                ...
                <table cellpadding="0px;" cellspacing="0px;" class="inputTable">
                    ...
                    <tr>
                        ...
                        <td class="tdText_2">
                            <asp:TextBox ID="txtFromDate" runat="server" Width="80px" OnTextChanged="FromDate_Changed"
                ...
                <table cellpadding="0px;" cellspacing="0px;" class="inputTable">
                    <tr>
                        ...
                        <td class="tdText_2">
                            ...
                            <asp:TextBox ID="txtProductCode" runat="server" Width="160px" OnTextChanged="Product_Changed"
