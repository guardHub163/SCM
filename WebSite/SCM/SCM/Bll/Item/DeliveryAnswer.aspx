<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="DeliveryAnswer.aspx.cs" Inherits="SCM.Web.Item.DeliveryAnswer" %>
            ...
            <ContentTemplate>
                <table id="tabSearch" cellpadding="0px;" cellspacing="0px;" class="inputTable">
                    ...
                    <tr>
                        ...
                        <td class="tdText">
                            <%--<input type="text" id="txtDepartureDate" runat="server" />--%>
                ...
                <asp:GridView ID="gridView" runat="server" CellPadding="0" DataKeyNames="SLIP_NUMBER"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            ...
                            <ControlStyle Height="15px" Width="40px"></ControlStyle>
