...
{
    public partial class ReceiptInput : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (SN != null)
                {
                    ...
                    this.lblTitle.InnerHtml = "入库&nbsp;>>&nbsp;原料入库&nbsp;>>&nbsp;编辑";
                    try
                    {
                    ...
                    else if (Request.Params["SHOW_FLAG"] != null && Request.Params["SHOW_FLAG"].ToString() == "1")
                    {
                        this.btnSave.Enabled = false;
                        this.btnSave.Visible = false;
                        this.lblTitle.InnerHtml = "入库&nbsp;>>&nbsp;原料入库&nbsp;>>&nbsp;详细";
                    }
                }
                else
                {
                    dt = InitDataTable();
                    this.lblTitle.InnerHtml = "入库&nbsp;>>&nbsp;原料入库&nbsp;>>&nbsp;临时入库";
                }
        ...
        protected override bool processBtnClick(string btnId, object sender, EventArgs e)
        {
            switch (btnId)
            {
                ...
                case "btnCancel":
                    ...
                    gridView.DataBind();
                    ViewState["RECEIPT_DATATABLE"] = dt;
                    //HttpContext.Current.Session.Remove("RECEIPT_DATATABLE");
                    //HttpContext.Current.Session.Remove("RECEIPT_DATATABLE");
                    break;
                case "btnProduct":
        ...
        private void Save(object sender, EventArgs e)
        {
            ...
            receiptTable.RECEIPT_TYPE = CConstant.SHIPMENT_TYPE_TEMP;
            ...
            receiptTable.CREATE_USER = _userTable.USER_ID;
            receiptTable.LAST_UPDATE_USER = _userTable.USER_ID;
