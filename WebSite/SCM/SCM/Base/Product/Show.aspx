<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Show.aspx.cs" Inherits="SCM.Web.Product.Show" Title="详细信息" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlace" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" class="inputTable" >
        ...
        <tr>
            ...
            <td class="tdText_3">
                <asp:Label ID="lblStyleCode" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
        <tr>
            <td class="tdTitle_3">
        ...
        <tr>
            ...
            <td class="tdText_3">
                <asp:Label ID="lblSizeCode" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
        <tr>
            <td class="tdTitle_3">
