<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Add.aspx.cs" Inherits="SCM.Web.Product.Add" Title="新建" %>
            ...
            <table class="inputTable"  cellpadding="0" cellspacing="0" >
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td class="tdText_3">
                            <asp:TextBox ID="txtStyleCode" runat="server" OnTextChanged="StyleCode_Chanage" AutoPostBack="true" Width="80" CssClass="inputText"></asp:TextBox>
