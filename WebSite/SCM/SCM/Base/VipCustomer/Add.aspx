<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Add.aspx.cs" Inherits="SCM.Web.VipCustomer.Add" Title="新建" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" class="inputTable" >
                ...
                <tr>
                    ...
                    <td class="tdText_3">
                        <asp:TextBox ID="txtLevel" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="tdTitle_3">
                ...
                <tr>
                    ...
                    <td class="tdText_3">
                        <asp:TextBox ID="txtDepartmentCode" runat="server" Width="60px" OnTextChanged="Department_Change" CssClass="inputText"
                ...
                <tr>
                    ...
                    <td class="tdText_3">
                        <asp:TextBox ID="txtBirthDate" runat="server" Width="80" OnTextChanged="BirthDate_Changed"
                            AutoPostBack="true" MaxLength="10"></asp:TextBox>
                        <img onclick="WdatePicker({el:'<%=this.txtBirthDate.ClientID%>'})" src="../../Script/My97DatePicker/skin/datePicker.gif"
                ...
                <tr>
                    ...
                    <td class="tdText_3">
                        <asp:TextBox ID="txtSalesTime" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="tdTitle_3">
