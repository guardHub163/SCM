<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="List.aspx.cs" Inherits="SCM.Web.Style.List" %>
    ...
    <div class="border_div">
        <table cellpadding="0px;" cellspacing="0px;" class="inputTable">
            <tr>
                ...
                <td class="tdText">
                    <asp:TextBox ID="txtStyleName" runat="server" Width="200"></asp:TextBox>
                </td>
            </tr>
        </table>
        <table class="searchTable" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <a href="#" id="btnCancel" class="LinkButton3" onclick="window.open('../../ExplainHtml/StyleExplain.htm')">导入明细</a>
