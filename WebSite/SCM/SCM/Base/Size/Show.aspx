<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Show.aspx.cs" Inherits="SCM.Web.Size.Show" Title="详细信息" %>
    ...
    <table cellpadding="0" cellspacing="0" class="inputTable" >
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="tdText_3">
                <asp:Label ID="lblProeuctgroupname" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
         <tr>
            <td class="tdTitle_3">
            ...
            <td class="tdText_3">
                <asp:Label ID="lblRefence" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
        <tr>
            <td class="tdTitle_3">
