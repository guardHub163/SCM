<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Show.aspx.cs" Inherits="SCM.Web.Warehouse.Show" Title="详细信息" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlace" runat="Server">
    ...
    <table  class="inputTable" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="tdText_3">
                <select id="selType" runat="server" style="width: 200px;">
        ...
        <tr>
            ...
            <td class="tdText_3">
                <asp:Label ID="lblDerartment_code" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
        <tr>
            <td class="tdTitle_3">
