<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="List.aspx.cs" Inherits="SCM.Web.Warehouse.List" Title="无标题页" %>
    ...
    <div class="border_div">
        <table class="inputTable" cellpadding="0px;" cellspacing="0px;">
            <tr>
                ...
                <td class="tdText">
                    <asp:TextBox ID="txtHouseName" runat="server" Width="200"></asp:TextBox>
                </td>
                <td class="tdTitle">
                    仓库类型：
                </td>
                <td class="tdText ">
                    <select id="DropHouseType" runat="server" style="width: 200px;">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
            <ContentTemplate>
                <asp:GridView ID="gridView" runat="server" CellPadding="0" DataKeyNames="CODE" OnRowDataBound="gridView_RowDataBound"
                    AutoGenerateColumns="False" RowStyle-HorizontalAlign="Center" EmptyDataText="查询结束,未找到匹配项!"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DEPARTMENT_NAME" HeaderText="部门" SortExpression="DEPARTMENT_NAME"
                            ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
