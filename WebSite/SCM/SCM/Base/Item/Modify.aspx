<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Modify.aspx.cs" Inherits="SCM.Web.Item.Modify" Title="编辑" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" class="inputTable" >
                ...
                <tr>
                    ...
                    <td class="tdText_3">
                        <asp:TextBox ID="txtUnitCode" runat="server" Width="80" OnTextChanged="UnitCode_Chanage" CssClass="inputText"
