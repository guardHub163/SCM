<%@ Page Language="C#" MasterPageFile="~/AJAXMasterPage.master" AutoEventWireup="true"
    CodeFile="Show.aspx.cs" Inherits="SCM.Web.Item.Show" Title="详细信息" %>
...
<table class="navigationChild">
    ...
    <table cellpadding="0" cellspacing="0" class="inputTable" >
        ...
        <tr>
            ...
            <td class="tdText_3">
                <asp:Label ID="lblUnit_name" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
        <tr>
            <td class="tdTitle_3">
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="tdText_3">
                <asp:Label ID="lblAttribute4" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
         <tr>
            <td class="tdTitle_3">
            ...
            <td class="tdText_3">
                <asp:Label ID="lblAttribute5" runat="server"></asp:Label> &nbsp;
            </td>
        </tr>
        <tr>
            <td class="tdTitle_3">
